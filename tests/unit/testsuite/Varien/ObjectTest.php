...
class Varien_ObjectTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function methodsDataProvider()
    {
        return array(
            ...
            array('__set', array('public')),
            array('isEmpty', array('public')),
            array('_underscore', array('protected')),
            array('_camelize', array('protected')),
            ...
            array('setDataChanges', array('public')),
            array('debug', array('public')),
            array('offsetSet', array('public')),
